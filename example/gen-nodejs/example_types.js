...
Tweet = module.exports.Tweet = function(args) {
  this.userId = null;
  this.userName = null;
  this.text = null;
  this.loc = null;
...
TweetSearchResult = module.exports.TweetSearchResult = function(args) {
  this.tweets = null;
  if (args) {
...
TwitterUnavailable = module.exports.TwitterUnavailable = function(args) {
  Thrift.TException.call(this, "TwitterUnavailable")
  this.name = "TwitterUnavailable"
  this.message = null;
  if (args) {
